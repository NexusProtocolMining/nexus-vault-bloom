  ...
  return (
    <motion.header
      ...
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
        isScrolled 
          ? 'bg-background/80 backdrop-blur-2xl border-b border-primary/15' 
          : 'bg-transparent'
      }`}
    >
        ...
        <div className="flex items-center justify-between h-20">
          ...
          <Link to="/" className="flex items-center gap-3 group">
            ...
            >
              ...
              <motion.div 
                className="absolute inset-0 border-2 border-primary/60 rounded-xl"
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          <motion.div
            ...
            className="lg:hidden bg-background/95 backdrop-blur-2xl border-b border-primary/20"
          >
            <div className="container mx-auto px-4 py-6">
                ...
                {navLinks.map((link, i) => (
                  ...
                  >
                    <Link
                      ...
                      className={`flex items-center gap-3 px-5 py-4 rounded-xl text-sm font-medium tracking-widest transition-all duration-300 ${
              ...
              <motion.div 
                className="mt-6 pt-6 border-t border-primary/20 sm:hidden"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
